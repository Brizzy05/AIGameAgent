...
def world_1(world_init):
    ...
    barriers = ((0, 0, 1),(0, 1, 1),(0, 1, 3),(0, 2, 3),(1, 2, 1),(1, 3, 3),(2, 1, 2),(2, 2, 2),(2, 3, 1),(2, 4, 3),(3, 0, 1),(3, 1, 0),(3, 1, 2),(3, 1, 3),(3, 2, 0),(4, 0, 1),(4, 1, 0),(4, 1, 3))
...
def world_2(world_init):
    ...
    world_init.turn = 0
    barriers = ((0, 0, 1),(0, 1, 1),(0, 1, 3),(0, 2, 2),(0, 2, 3),(1, 2, 0),(1, 2, 1),(1, 3, 3),(2, 1, 2),(2, 2, 1),(2, 2, 2),(2, 3, 1),(2, 3, 3),(2, 4, 3),(3, 0, 1),(3, 1, 0),(3, 1, 2),(3, 1, 3),(3, 2, 0),(4, 0, 1),(4, 1, 0),(4, 1, 3))
